...
namespace testappwatch.wkExtension
{
	...
	public class ExtensionDelegate : WKExtensionDelegate
	{
		...
		{
			NSDecimal number = get_number2 ();
			Console.WriteLine ($"NSDecimal (2): {number.fields} {number.m1} {number.m2} {number.m3} {number.m4} {number.m5} {number.m6} {number.m7} {number.m8}");
		...
		static extern NSDecimal get_number2 ();
